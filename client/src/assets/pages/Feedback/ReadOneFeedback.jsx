...
const ReadOneFeedback = () => {
  ...
  return (
    <div class="container mx-auto px-4 py-8">
      ...
      <p className="mb-2">
        <span className="font-bold">Email:</span> {feedback.email}
      </p>
      <p className="mb-2">
        <span className="font-bold">Message:</span> {feedback.message}
      </p>

      <p className="mb-2">
        <span className="font-bold">Phone Number:</span> {feedback.phone_number}
      </p>
      <p className="mb-2">
