        ...
        <table className='w-full border-separate boarder-spacing-2' ref={componentRef}>
          <thead>
            <tr>
              ...
              <th className='border-3 border-slate-600 rounded-md bg-red-500 font-bold text-black'>BookingID</th>
              <th className='border-3 border-slate-600 rounded-md bg-red-500 font-bold text-black'>cusID</th>
